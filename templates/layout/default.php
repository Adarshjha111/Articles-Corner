        ...
        <body>
                    ...
                    { ?>
                        ...
                        <nav class="top-nav" class="container-fluid">
                            ...
                            <div class="top-nav-links">
                                <?= $this->Html->link('Home', array('controller'=>'Articles','action' => 'index')) ?>
                                <?= $this->Html->link('Create', array('controller'=>'Articles','action' => 'add')) ?>
                                <?= $this->Html->link('Logout', array('controller'=>'Users','action' => 'logout')) ?>

                                <?= $this->Form->create(null, ['url' => ['controller' => 'Articles', 'action' => 'search']]) ?>
                                <?= $this->Form->input('q', ['label' => 'Search Term']) ?>
                    ...
                    <?php } 
                            ...
                            <nav class="top-nav">
                                ...
                                <div class="top-nav-links" class="container-fluid">
                                    ...
                                    <?= $this->Html->link('Signup!', array('controller'=>'Users','action' => 'add')) ?>
                                </div>
                            </nav>
            ...
            <footer>
                ...
                <div class="footer-bottom">
                    <p>copyright &copy; <a href="#">Yours Truely</a>  </p>
